...
export function AdminNavbar() {
  ...
  const { goToProfile, goToLogin } = useAdminNavigation()
    ...
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm">
      <div className="grid h-16 w-full grid-cols-3 items-center px-8">
        ...
        <div className="flex justify-start">
          <Link href="/admin/home" className="text-2xl font-bold text-blue-600">
            LMS Admin
          </Link>
        </div>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 top-full mt-2 w-44 rounded-lg border border-gray-100 bg-white py-2 shadow-lg">
                ...
                <button
                  ...
                  className="flex w-full items-center gap-2 px-4 py-2 text-left text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                >
