...
export default function CreateAssignmentPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    console.log("[v0] Assignment created:", { ...formData, files: uploadedFiles })
  }
          ...
          <div className="rounded-[20px] border border-gray-200 bg-white p-8">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="dueDate" className="block text-sm font-semibold text-gray-900 mb-3">Due Date</label>
                  <input
                    id="dueDate"
                    type="date"
                    name="dueDate"
                ...
                <div>
                  <label htmlFor="marks" className="block text-sm font-semibold text-gray-900 mb-3">Marks</label>
                  <input
                    id="marks"
                    type="number"
                    name="marks"
