...
export default function FacultyLoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("[v0] Faculty login attempt:", { id: formData.id })
  }
      ...
      <Card className="w-full max-w-md border-0 shadow-lg">
        <div className="space-y-6 p-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-lg font-semibold text-slate-700">Faculty Login</p>
            <p className="mt-1 text-sm text-slate-500">Course management portal</p>
          </div>
          ...
          <p className="text-center text-xs text-slate-500">
            Faculty portal for course and assignment management.
          </p>
        </div>
      </Card>
    </div>
