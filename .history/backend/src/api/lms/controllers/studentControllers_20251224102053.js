...
export const getAttempts = async (req, res) => {
    try {
        ...
        const attempts = await lmsAttempt.find({ student: studentId, quiz: quizId });
...
export const reviewQuiz = async (req, res) => {
    try {
        ...
        const attempt = await lmsAttempt.findOne({ student: studentId, quiz: quizId, _id:reviewId }).select("-_id answers score").populate({
