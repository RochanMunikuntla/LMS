...
export const submitCodeToTopic = async (req, res) => {
    try {
        const { language_id, sourceCode } = req.body;
...
export const runCodeForProblem = async (req, res) => {
    try {
        ...
        const samples = await CodingQuestion.findById(problemId).select("samples");
...
export const submitCodeToProblem = async (req, res) => {
    try {
        ...
        const hiddenTC = await CodingQuestion.findById(problemId).select("hiddenTests");
