...
export const Quiz = mongoose.model("careerQuiz", quizSchema);
export const Question = mongoose.model("careerQuestion", questionSchema);
export const Attempt = mongoose.model("careerAttempt", attemptSchema);
