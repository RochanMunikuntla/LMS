...
import { home, enrollRoadmap, derollRoadmap, getAllTopics, getAllModules, getTopic, profile, createProjectCollab, getAllProjectCollab } from "../controllers/learnerControllers.js";
...
router.get("/projecthub", ProjectCollab);
router.get("/projecthub/:projecthubId", getAllProjectCollab);
