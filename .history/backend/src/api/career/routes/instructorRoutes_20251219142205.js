...
import { addCodingQuestions, addLanguage, createModule, createQuiz, createRoadmap, createTopic, deleteRoadmap } from "../controllers/instructorControllers.js";
...
//Coding
router.post("/coding/language", upload.single("file")addLanguage);
router.post("/coding/problems", addCodingQuestions);
