...
router.get("/roadmap/:roadmapId/module/:moduleId/topic/:topicId/submissions", getAllSubmissions);
router.get("/roadmap/:roadmapId/module/:moduleId/topic/:topicId/submissions/:topicSubmissionId", getSubmission);
