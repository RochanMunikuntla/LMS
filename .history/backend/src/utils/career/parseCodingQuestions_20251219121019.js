...
for(let i = 0;i<data.length;i++){
    ...
    // for(let j = 0;j<data[i].constraints.inputConstraints.length;i)
    let inputConstraints = data[i].constraints.timeLimitMs;
}

console.log(data[0].constraints.inputConstraints.length)