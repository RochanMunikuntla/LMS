...
router.get("/courses/assignment/:assignmentId", getAssignment);
router.post("/courses/assignments", createAssignment);
router.put("/courses/assignments/:assignmentId", editAssignment);
router.delete("/courses/assignments/:assignmentId", removeAssignment);
